...
class TestFortuneAnalyzer(unittest.TestCase):
    ...
    def test_calculate_enamae_score(self):
        ...
        test_cases = [
            {
                "input": {"天格": "大吉", "人格": "吉", "地格": "特殊格", "外格": "大吉", "総格": "吉", "三才配置": "大吉"},
                "expected": 91.67  # (100 + 80 + 90 + 100 + 80 + 100) / 6 = 91.66666...
            },
            {
                "input": {"天格": "凶", "人格": "大凶", "地格": "吉", "外格": "凶", "総格": "大吉", "三才配置": "吉"},
                "expected": 60.0  # (40 + 20 + 80 + 40 + 100 + 80) / 6 = 60.0
            },
            {
                "input": {"天格": "吉凶混合", "人格": "吉", "地格": "大吉", "外格": "特殊格", "総格": "大吉", "三才配置": "吉"},
        ...
        for case in test_cases:
            ...
            self.assertAlmostEqual(score, case["expected"], places=1,
    ...
    def test_calculate_namaeuranai_score(self):
        ...
        test_cases = [
            {
                "input": {"天格": "大大吉", "人格": "大吉", "地格": "吉", "外格": "大吉", "総格": "吉", "仕事運": "大大吉", "家庭運": "大吉"},
                "expected": 90.0  # (100 + 90 + 80 + 90 + 80 + 100 + 90) / 7 = 90.0
            },
            {
                "input": {"天格": "凶", "人格": "大凶", "地格": "吉", "外格": "凶", "総格": "大吉", "仕事運": "吉", "家庭運": "大凶"},
                "expected": 52.86  # 実際のスコア: 52.857142857142854
            },
            {
                "input": {"天格": "大吉", "人格": "吉", "地格": "大大吉", "外格": "大吉", "総格": "吉", "仕事運": "大吉", "家庭運": "大大吉"},
    ...
    def test_calculate_total_score(self):
        ...
        test_cases = [
            {
                "input": {
                    "enamae": {"天格": "大吉", "人格": "吉", "地格": "特殊格", "外格": "大吉", "総格": "吉", "三才配置": "大吉"},
                    "namaeuranai": {"天格": "大大吉", "人格": "大吉", "地格": "吉", "外格": "大吉", "総格": "吉", "仕事運": "大大吉", "家庭運": "大吉"}
                },
                "expected": 90.83  # (91.67 + 90.0) / 2 = 90.835
            },
            {
                "input": {
                    "enamae": {"天格": "凶", "人格": "大凶", "地格": "吉", "外格": "凶", "総格": "大吉", "三才配置": "吉"},
                    "namaeuranai": {"天格": "凶", "人格": "大凶", "地格": "吉", "外格": "凶", "総格": "大吉", "仕事運": "吉", "家庭運": "大凶"}
                },
