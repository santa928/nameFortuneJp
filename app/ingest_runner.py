...
def main() -> None:
    ...
    parser.add_argument(
        "--strokes2", type=int, help="2文字目の画数 (文字数2以上の場合必須)"
    )
    parser.add_argument(
        "--strokes3", type=int, help="3文字目の画数 (文字数3の場合必須)"
    )
    parser.add_argument(
        "--gender",
        type=str,
    ...
    print(
        f"[INGEST] chars={args.chars}, strokes1={args.strokes1}, "
        f"strokes2={args.strokes2}, strokes3={args.strokes3}, "
